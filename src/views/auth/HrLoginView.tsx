        ...
        <div className="nexus-card p-6 bg-white border border-slate-200/80 shadow-2xl rounded-3xl space-y-4">
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-3.5 pt-1">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Enter HR email or mobile number"
            ...
            <div className="flex justify-end">
              <button
                type="button"
                onClick={() => triggerToast('HR security password recovery link dispatched')}
            ...
            >
              <span>{isLoading ? 'Verifying Credentials...' : 'Login as HR Officer'}</span>
