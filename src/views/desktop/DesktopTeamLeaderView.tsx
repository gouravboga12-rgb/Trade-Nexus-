              ...
              <div className="space-y-3">
                {activeMeetings.map((mtg) => {
                  ...
                  return (
                    <div 
                      key={mtg.id} 
                      className={`p-4 border-2 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm animate-in slide-in-from-top-2 ${
                        isLive 
                    ...
                    >
                        ...
                        <div>
                          <div className="flex items-center gap-2 flex-wrap">
                            <span className={`text-[10px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider ${
                              ...
                              {isLive ? '🔴 Live Call in Progress' : '📅 Scheduled Meeting'}
                            </span>
                            {mtg.zoomMeetingId && (
                            ...
                            <span className="text-xs font-mono text-slate-500 font-semibold">
                              {mtg.dateTime ? `Time: ${mtg.dateTime} • ` : ''}Host: {mtg.hostName || 'Team Leader'}
                            </span>
                          </div>
                          ...
                          <p className="text-xs text-slate-500 font-medium">
                            {mtg.invitedMemberName ? `Invited: ${mtg.invitedMemberName}` : `Open to squad members (${teamMembers.length} employees)`} • 1-tap launch or enter video room
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-2 bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 rounded-xl text-xs font-bold flex items-center gap-1.5 shadow-2xs"
                        >
                        ...
                        <button
                          ...
                          className={`px-5 py-2.5 font-black text-xs rounded-xl flex items-center gap-2 shadow-md transition-all active:scale-95 cursor-pointer ${
                            isLive 
                        ...
                        >
                          ...
                          <span>{isLive ? 'Join Live Room' : 'Start Zoom Meeting'}</span>
                        </button>
                      </div>
                    </div>
                  );
